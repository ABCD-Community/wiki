...
Cuando elaboramos una FST es necesario tener claro el concepto de cómo se almacenan los términos en la lista invertida (ver [Estructura de los archivos invertidos](/wiki/docs/es/99-cdsisis/index-files))
...
(ver: [Control de terminología: Listas de autoridades](/wiki/docs/es/2-cataloging/control-terms)).
