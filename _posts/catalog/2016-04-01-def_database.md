...
El acceso via http a los documentos digitales variará, de acuerdo al
...
## Formato de validación de duplicados (a través de un formato utilizado como format exit)
## Formato de validación de duplicados (FDT) (marcando el campo como clave única en la FDT)
## Formato para condicionar la eliminación de registros
## Validacion del ingreso aplicando funciones JavaScript construídas dinámicamente por ABCD
